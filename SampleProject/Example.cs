...
namespace SampleProject
{
    public class Example
    {
        ...
        static List<KeyValuePair<string, string>> hashMap;
        static void Main(string[] args)
        {

            Interswitch.Init(clientId, clientSecret, "https://qa.interswitchng.com");

            var mod = "";
            var pubExponent = "010001";
            ...
            var authdata = Interswitch.GetAuthdata("5060990580000217499", "1111", "2004", "111");
            Console.WriteLine("*******************************");
            ...
            var authdataWithModulusExponent = Interswitch.GetAuthdata(mod, pubExponent, "5060990580000217499", "1111", "2004", "111");
            Console.WriteLine("*******************************");
            ...
            var paymentWithTokenHeadersSignedParamentResponse = Interswitch.Send("/api/v2/purchases", "POST", paymentRequest, token, hashMap, null).Result;
